    ...
    >
      <div className="rounded-[45px] border border-white/40 bg-white/60 p-8 shadow-[0_10px_40px_rgba(0,0,0,0.02)] backdrop-blur-xl">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#941c1c]/40">ADMINISTRAÇÃO</p>
            <h1 className="mt-1 text-[44px] font-black leading-tight text-[#941c1c]">Cadastros</h1>
